  ...
  return (
    <div className="flex items-center gap-3 rounded-lg border border-border-primary bg-bg-secondary p-3 font-sans">
      ...
      <div className="min-w-0 flex-1">
        {body && (
          <div className="text-sm text-text-primary">{body}</div>
        )}
        {url && (
      ...
      {url && (
        <a
          ...
          className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md text-text-secondary transition-colors hover:bg-bg-hover-primary hover:text-text-primary focus:outline-none focus-visible:bg-bg-hover-primary"
        >
